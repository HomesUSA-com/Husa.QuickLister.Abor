namespace Husa.Quicklister.Abor.Api.Tests.Controllers.Media
{
    ...
    public class CommunitySaleMediaControllerTests
    {
        ...
        public async Task CreateResources_ResourcesAdded_Success()
        {
            ...
            this.communityMediaService.Setup(m => m.Resource.CreateAsync(It.IsAny<Guid>(), It.IsAny<Request.Media>(), It.Is<int>(x => x == 5)))
                .Verifiable();
            ...
            this.communityMediaService.Verify(x => x.Resource.CreateAsync(It.Is<Guid>(x => x == entityId), It.Is<Request.Media>(m => m == media), It.IsAny<int>()), Times.Once);
        }
