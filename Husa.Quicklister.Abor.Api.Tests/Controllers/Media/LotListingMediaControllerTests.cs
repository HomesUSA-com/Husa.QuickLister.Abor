namespace Husa.Quicklister.Abor.Api.Tests.Controllers.Media
{
    ...
    public class LotListingMediaControllerTests
    {
        private readonly Mock<ILotListingMediaService> listingMediaService;
        private readonly Mock<ILogger<LotListingMediaController>> logger;

        public LotListingMediaControllerTests(ApplicationServicesFixture fixture)
        {
            this.logger = new Mock<ILogger<LotListingMediaController>>();
            this.listingMediaService = new Mock<ILotListingMediaService>();
            this.Sut = new LotListingMediaController(this.listingMediaService.Object, fixture.Options.Object, this.logger.Object);
        }

        public LotListingMediaController Sut { get; set; }
