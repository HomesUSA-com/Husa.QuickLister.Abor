namespace Husa.Quicklister.Abor.Api.Tests.Listing
{
    ...
    public class ListingSaleMediaControllerTests
    {
        private readonly Mock<ISaleListingMediaService> listingMediaService;
        private readonly Mock<ILogger<SaleListingMediaController>> logger;

        public ListingSaleMediaControllerTests(ApplicationServicesFixture fixture)
        {
            this.logger = new Mock<ILogger<SaleListingMediaController>>();
            this.listingMediaService = new Mock<ISaleListingMediaService>();
            this.Sut = new SaleListingMediaController(this.listingMediaService.Object, fixture.Options.Object, this.logger.Object);
        }

        public SaleListingMediaController Sut { get; set; }
        ...
        public async Task GetResources_ResourcesFound_Success()
        {
            ...
            this.listingMediaService.Setup(x => x.GetAsync(It.IsAny<Guid>())).ReturnsAsync(response).Verifiable();
            ...
            this.listingMediaService.Verify();
        }
        ...
        public async Task GetResources_ResourcesEmpty_Success()
        {
            ...
            this.listingMediaService.Setup(m => m.GetAsync(It.Is<Guid>(x => x == listingId)))
        ...
        public async Task CreateResources_ResourcesAdded_Success()
        {
            ...
            this.listingMediaService.Setup(m => m.Resource.CreateAsync(It.IsAny<Guid>(), It.IsAny<MarketCode>(), It.IsAny<Request.Media>(), It.IsAny<int>()))
                .Verifiable();
            ...
            this.listingMediaService.Verify(x => x.Resource.CreateAsync(It.Is<Guid>(x => x == listingId), It.IsAny<MarketCode>(), It.Is<Request.Media>(m => m == simpleMedia), It.IsAny<int>()), Times.Once);
        }
        ...
        public async Task UpdateResources_ResourcesUpdated_Success()
        {
            ...
            this.listingMediaService.Setup(m => m.Resource.UpdateAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Request.Media>()))
                .Verifiable();
            ...
            // Assert
            Assert.IsAssignableFrom<OkResult>(actionResult);
            this.listingMediaService.Verify(x => x.Resource.UpdateAsync(It.Is<Guid>(x => x == listingId), It.Is<Guid>(x => x == mediaId), It.Is<Request.Media>(m => m == media)), Times.Once);
        }
        ...
        public async Task GetMediaById_MediaFound_Success()
        {
            ...
            this.listingMediaService.Setup(m => m.Resource.GetById(It.IsAny<Guid>(), It.IsAny<Guid>()))
        ...
        public async Task GetMediaById_MediaNotFound_Success()
        {
            ...
            this.listingMediaService.Setup(m => m.Resource.GetById(It.Is<Guid>(x => x == listingId), It.Is<Guid>(x => x == mediaId)))
                .ReturnsAsync(mediaDetail)
                .Verifiable();
        ...
        public async Task DeleteResources_MediaDeleted_Success()
        {
            // Arrange
            var listingId = Guid.NewGuid();
            this.listingMediaService.Setup(x => x.Resource.DeleteAsync(It.Is<Guid>(x => x == listingId), It.IsAny<bool>())).Verifiable();

            // Act and Assert
            Assert.IsAssignableFrom<OkResult>(await this.Sut.DeleteResources(listingId));
            this.listingMediaService.Verify(x => x.Resource.DeleteAsync(It.Is<Guid>(x => x == listingId), It.IsAny<bool>()), Times.Once);
        }
    }
}
