namespace Husa.Quicklister.Abor.Crosscutting.Tests
{
    ...
    public class EnumExtensionsTest
    {
        ...
        [Theory]
        [InlineData(typeof(AcceptableFinancing))]
        [InlineData(typeof(Cities))]
        [InlineData(typeof(ConstructionMaterials))]
        [InlineData(typeof(CoolingSystem))]
        [InlineData(typeof(Counties))]
        [InlineData(typeof(DistanceToWaterAccess))]
        ...
        [InlineData(typeof(GuestAccommodationsDescription))]
