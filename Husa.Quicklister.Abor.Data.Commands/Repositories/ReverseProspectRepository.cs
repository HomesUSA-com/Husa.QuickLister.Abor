namespace Husa.Quicklister.Abor.Data.Commands.Repositories
{
    ...
    public class ReverseProspectRepository : Repository<TrackingReverseProspect>, IReverseProspectRepository
    {
        ...
        public Task<TrackingReverseProspect> GetReverseProspectByTrackingId(Guid listingId)
        {
            this.logger.LogInformation($"Starting to get Reverse prospect listing with id {listingId} from tracking table");

            return this.context.TrackingReverseProspect
