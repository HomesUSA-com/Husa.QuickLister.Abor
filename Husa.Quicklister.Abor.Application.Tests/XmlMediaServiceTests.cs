namespace Husa.Quicklister.Abor.Application.Tests
{
    ...
    public class XmlMediaServiceTests
    {
        ...
        private readonly Mock<IMediaMessagingService> mediaMessagingService = new();
        ...
        public async Task ImportXmlSubdivisionMediaXmlSubdivisionNotFound()
        {
            ...
            var sut = new XmlMediaService(
                ...
                this.mediaMessagingService.Object,
        ...
        public async Task ImportXmlSubdivisionMediaXmlSubdivisionHasNoMedia()
        {
            ...
            // Assert
            this.mediaMessagingService
                .Verify(
                    c => c.SendMessage(
                        It.IsAny<IEnumerable<MediaCreateMessage>>(),
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        It.IsAny<bool>()),
                    Times.Never);
        ...
        public async Task ImportXmlSubdivisionMediaSuccess()
        {
            ...
            this.mediaMessagingService
                .Setup(c => c.SendMessage(
                    ...
                    It.Is<string>(correlationId => correlationId == traceId),
                    It.Is<bool>(dispose => dispose)))
                .Verifiable();
            ...
            this.mediaMessagingService.Verify();
        ...
        public async Task ImportXmlListingMediaXmlListingCheckingMediaLimit()
        {
            ...
            // Act
            await sut.ImportListingMedia(xmlListingId, checkMediaLimit: true);
