    ...
    public class SaleListingXmlServiceTests
    {
        ...
        public async Task UpdateListingAsyncWithoutRequestSuccess()
        {
            ...
            this.saleListingRequestService
              .Setup(x => x.CreateRequestAsync(It.IsAny<IListing>(), It.IsAny<XmlListingDetailResponse>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
        ...
        public async Task UpdateListingAsyncWithRequestGeneratedSuccess()
        {
            ...
            await this.Sut.UpdateListingFromXmlAsync(xmlListingId);
            this.listingSaleRepository.Verify(x => x.GetListingByXmlListingId(It.Is<Guid>(r => r == xmlListingId)), Times.Once);
            this.saleListingRequestService.Verify(x => x.CreateRequestAsync(It.IsAny<IListing>(), It.IsAny<XmlListingDetailResponse>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task UpdateListingAsynErrorsCreatingRequestSuccess()
        {
            ...
            // Act and Assert
            await this.Sut.UpdateListingFromXmlAsync(xmlListingId);
            this.saleListingRequestService.Verify(x => x.CreateRequestAsync(It.IsAny<IListing>(), It.IsAny<XmlListingDetailResponse>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        private void SetupServicesToUpdateListingFromXml(SaleListing listing)
        {
            ...
            this.saleListingRequestService
               .Setup(x => x.CreateRequestAsync(It.IsAny<SaleListing>(), It.IsAny<XmlListingDetailResponse>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
               .Verifiable();
