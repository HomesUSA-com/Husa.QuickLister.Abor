namespace Husa.Quicklister.Abor.Domain.Enums.Domain
{
    ...
    public enum SchoolDistrict
    {
        ...
        Coupland,
        [EnumMember(Value = "CueroISD")]
        [Description("Cuero ISD")]
        Cuero,
        [EnumMember(Value = "DelValleISD")]
        [Description("Del Valle ISD")]
        DelValle,
        [EnumMember(Value = "DimeBoxISD")]
        [Description("Dime Box ISD")]
        DimeBox,
        [EnumMember(Value = "DossISD")]
        [Description("Doss ISD")]
        Doss,
        [EnumMember(Value = "DrippingSpringsISD")]
        [Description("Dripping Springs ISD")]
        DrippingSprings,
        [EnumMember(Value = "EanesISD")]
        [Description("Eanes ISD")]
        Eanes,
        [EnumMember(Value = "ElginISD")]
        ...
        Florence,
        [EnumMember(Value = "FredericksburgISD")]
        ...
        Moody,
        [EnumMember(Value = "MoultonISD")]
        [Description("Moulton ISD")]
        Moulton,
        [EnumMember(Value = "NavarroISD")]
        [Description("Navarro ISD")]
        Navarro,
        [EnumMember(Value = "NewBraunfelsISD")]
        [Description("New Braunfels ISD")]
        NewBraunfels,
        [EnumMember(Value = "Nixon-SmileyConsISD")]
        [Description("Nixon-Smiley Cons ISD")]
        NixonSmileyCons,
        [EnumMember(Value = "Other")]
        [Description("Other")]
        Other,
        [EnumMember(Value = "PflugervilleISD")]
        [Description("Pflugerville ISD")]
        Pflugerville,
        [EnumMember(Value = "PrairieLeaISD")]
        ...
        Rogers,
        [EnumMember(Value = "Rosebud-LottISD")]
        [Description("Rosebud-Lott ISD")]
        RosebudLott,
        [EnumMember(Value = "RoundRockISD")]
        [Description("Round Rock ISD")]
        RoundRock,
        [EnumMember(Value = "RoundTop-CarmineISD")]
        [Description("Round Top-Carmine ISD")]
        RoundTopCarmine,
        [EnumMember(Value = "SaladoISD")]
        [Description("Salado ISD")]
        Salado,
        [EnumMember(Value = "SanMarcosISD")]
        [Description("San Marcos ISD")]
        SanMarcos,
        [EnumMember(Value = "SanSabaISD")]
        [Description("San Saba ISD")]
        SanSaba,
        [EnumMember(Value = "Schertz-Cibolo-UniversalISD")]
        [Description("Schertz-Cibolo-Universal ISD")]
        SchertzCiboloUniversal,
        [EnumMember(Value = "SchulenburgISD")]
        [Description("Schulenburg ISD")]
        Schulenburg,
        [EnumMember(Value = "SeguinISD")]
        [Description("Seguin ISD")]
        Seguin,
        [EnumMember(Value = "ShinerISD")]
        [Description("Shiner ISD")]
        Shiner,
        [EnumMember(Value = "SmithvilleISD")]
        [Description("Smithville ISD")]
        Smithville,
