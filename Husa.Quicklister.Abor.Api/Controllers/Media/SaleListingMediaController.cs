namespace Husa.Quicklister.Abor.Api.Controllers.Media
{
    ...
    [ApiController]
    [Route("sale-listings/{listingId}/media")]
    public class SaleListingMediaController : Controller
    {
        ...
        public async Task<IActionResult> CreateAsync([FromRoute] Guid listingId, [FromBody] Media media)
        {
            ...
            await this.listingMediaService.Resource.CreateAsync(listingId, MarketCode.SanAntonio, media, mediaLimitAllowed: this.options.MediaAllowed.SaleListingMaxAllowedMedia);
        ...
        public async Task<IActionResult> ReplaceAsync([FromRoute] Guid listingId, [FromBody] Media media)
        {
            ...
            await this.listingMediaService.Resource.ReplaceAsync(listingId, MarketCode.SanAntonio, media);
        ...
        public async Task<IActionResult> DeleteResource([FromRoute] Guid listingId, [FromRoute] Guid mediaId)
        {
            ...
            await this.listingMediaService.Resource.DeleteByIdAsync(listingId, mediaId, mediaLimitAllowed: this.options.MediaAllowed.SaleListingMaxAllowedMedia);
        ...
        [HttpPatch("{mediaId}")]
        [ApiAuthorization(RoleEmployee.CompanyAdmin, RoleEmployee.SalesEmployee)]
        public async Task<IActionResult> UpdateAsync([FromRoute] Guid listingId, [FromRoute] Guid mediaId, [FromBody] Media media)
        {
        ...
        public async Task<IActionResult> UpdateResourcesAsync([FromRoute] Guid listingId, [FromBody] IEnumerable<Media> media)
        {
            ...
            await this.listingMediaService.Resource.BulkUpdateAsync(listingId, media, mediaLimitAllowed: this.options.MediaAllowed.SaleListingMaxAllowedMedia);
        ...
        public async Task<IActionResult> ImportMediaAsync([FromRoute] Guid listingId, [FromBody] IEnumerable<ImportMedia> media)
        {
            ...
            await this.listingMediaService.Resource.ImportAsync(listingId, media, mediaLimitAllowed: this.options.MediaAllowed.SaleListingMaxAllowedMedia);
