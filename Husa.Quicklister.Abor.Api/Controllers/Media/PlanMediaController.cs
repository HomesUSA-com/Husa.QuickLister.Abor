namespace Husa.Quicklister.Abor.Api.Controllers.Media
{
    ...
    public class PlanMediaController : Controller
    {
        ...
        public async Task<IActionResult> CreateAsync([FromRoute] Guid planId, [FromBody] Media media)
        {
            ...
            await this.planMediaService.Resource.CreateAsync(planId, MarketCode.SanAntonio, media, mediaLimitAllowed: this.options.MediaAllowed.PlanMaxAllowedMedia);
        ...
        public async Task<IActionResult> ReplaceAsync([FromRoute] Guid planId, [FromBody] Media media)
        {
            ...
            await this.planMediaService.Resource.ReplaceAsync(planId, MarketCode.SanAntonio, media);
        ...
        [HttpPatch("{mediaId}")]
        [ApiAuthorization(RoleEmployee.CompanyAdmin)]
        public async Task<IActionResult> UpdateAsync([FromRoute] Guid planId, [FromRoute] Guid mediaId, [FromBody] Media media)
        {
        ...
        [HttpPatch]
        [ApiAuthorization(RoleEmployee.CompanyAdmin, RoleEmployee.SalesEmployee)]
        public async Task<IActionResult> UpdateResourcesAsync([FromRoute] Guid planId, [FromBody] IEnumerable<Media> media)
        {
