namespace Husa.Quicklister.Abor.Api.ServiceBus.Helpers
{
    using System;
    ...
    {
        public static UserContext GetDownloaderUser(DownloaderUserSettings userSettings) => new()
        {
        ...
        public static void ConfigureContext(Message message, DownloaderUserSettings userSettings, IServiceScope scope)
        {
            var userProvider = scope.ServiceProvider.GetRequiredService<IUserProvider>();
            userProvider.SetCurrentUser(GetDownloaderUser(userSettings));
