    ...
    public class ListingSaleMappingProfile : Profile
    {
        ...
        private void MapResidentialDownloaderToFullListingDto()
        {
            this.CreateMap<ResidentialValueMessage, FullListingSaleDto>()
                ...
                .ForPath(dto => dto.SaleProperty.SpacesDimensionsInfo.Stories, config => config.MapFrom(dto => dto.Stories.ToStories()))
                ...
                .ForPath(dto => dto.SaleProperty.SpacesDimensionsInfo.NumBedrooms, config => config.MapFrom(dto => dto.Bedrooms))
                .ForPath(dto => dto.SaleProperty.SpacesDimensionsInfo.BathsFull, config => config.MapFrom(dto => dto.FullBaths))
                .ForPath(dto => dto.SaleProperty.SpacesDimensionsInfo.BathsHalf, config => config.MapFrom(dto => dto.HalfBaths))
                .ForPath(dto => dto.SaleProperty.SpacesDimensionsInfo.GarageDescription, config => config.MapFrom(dto => dto.GarageDescription.CsvToEnum<GarageDescription>(true)))
                ...
                .ForPath(dto => dto.SaleProperty.FeaturesInfo.Floors, config => config.MapFrom(dto => dto.Flooring.CsvToEnum<Floors>(true)))
                .ForPath(dto => dto.SaleProperty.FeaturesInfo.WindowCoverings, config => config.MapFrom(dto => dto.WindowCoverings.CsvToEnum<WindowCoverings>(true)))
                ...
                .ForPath(dto => dto.SaleProperty.ShowingInfo.AgentListApptPhone, config => config.MapFrom(dto => dto.ApptPhone))
                ...
                .ForPath(dto => dto.SaleProperty.ShowingInfo.Showing, config => config.MapFrom(dto => dto.Showing.ToShowing()))
