    ...
    public class ListingRequestMappingProfile : Profile
    {
        public ListingRequestMappingProfile()
        {
            this.CreateMap<AddressResponse, AddressRecord>()
                ...
                .ForMember(dto => dto.ReadableCity, pr => pr.MapFrom(x => x.City.ToCity().GetEnumDescription()))
            ...
            this.CreateMap<FeaturesResponse, FeaturesRecord>()
                ...
                .ForMember(dto => dto.Disclosures, pr => pr.Ignore())
                .ForMember(dto => dto.DocumentsAvailable, pr => pr.Ignore())
            ...
            this.CreateMap<FinancialResponse, FinancialRecord>()
                ...
                .ForMember(dto => dto.ReadableAgentBonusAmount, pr => pr.MapFrom(x => x.AgentBonusAmount.GetCommissionAmount(x.AgentBonusAmountType.ToEnumOrNullFromEnumMember<CommissionType>())))
                .ForMember(dto => dto.AgentBonusAmountType, pr => pr.MapFrom(x => x.AgentBonusAmountType.ToEnumOrNullFromEnumMember<CommissionType>()))
                .ForMember(dto => dto.ReadableBuyersAgentCommission, pr => pr.MapFrom(x => x.BuyersAgentCommission.GetCommissionAmount(x.BuyersAgentCommissionType.ToEnumOrNullFromEnumMember<CommissionType>())))
            ...
            this.CreateMap<SchoolsResponse, SchoolRecord>()
                ...
                .ForMember(dto => dto.SchoolDistrict, pr => pr.MapFrom(x => x.SchoolDistrict.ToSchoolDistrict()));
            ...
            this.CreateMap<PublishResponse, PublishFieldsRecord>()
                ...
                .ForMember(dto => dto.PublishStatus, pr => pr.MapFrom(x => x.PublishStatus.ToEnumOrNullFromEnumMember<MarketStatuses>()))
