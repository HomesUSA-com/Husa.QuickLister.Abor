    ...
    public class CommuntiyMappingProfile : Profile
    {
        public CommuntiyMappingProfile()
        {
            ...
            this.CreateMap<PropertyResponse, Property>()
                .ForMember(dto => dto.MapscoGrid, cr => cr.MapFrom(x => x.MapscoMapCoord));
            ...
            this.CreateMap<UtilitiesReponse, Utilities>()
                ...
                .ForMember(dto => dto.Exterior, cr => cr.MapFrom(x => x.Exterior.CsvToEnum<Exterior>(true)))
                .ForMember(dto => dto.Accessibility, cr => cr.MapFrom(x => x.Accessibility.CsvToEnum<Accessibility>(true)))
                .ForMember(dto => dto.EnergyFeatures, cr => cr.MapFrom(x => x.EnergyFeatures.CsvToEnum<EnergyFeatures>(true)))
                ...
                .ForMember(dto => dto.HasAccessibility, cr => cr.MapFrom(x => !string.IsNullOrEmpty(x.Accessibility)))
                ...
                .ForMember(dto => dto.GreenCertification, cr => cr.MapFrom(x => x.GreenCertification.CsvToEnum<GreenCertification>(true)))
                .ForMember(dto => dto.GreenFeatures, cr => cr.MapFrom(x => x.GreenFeatures.CsvToEnum<GreenFeatures>(true)))
                .ForMember(dto => dto.Floors, cr => cr.MapFrom(x => x.Floors.CsvToEnum<Floors>(true)))
                .ForMember(dto => dto.HeatingFuel, cr => cr.MapFrom(x => x.HeatingFuel.CsvToEnum<HeatingFuel>(true)))
                .ForMember(dto => dto.HeatSystem, cr => cr.MapFrom(x => x.HeatSystem.CsvToEnum<HeatingSystem>(true)))
                .ForMember(dto => dto.Inclusions, cr => cr.MapFrom(x => x.Inclusions.CsvToEnum<Inclusions>(true)))
                .ForMember(dto => dto.RoofDescription, cr => cr.MapFrom(x => x.RoofDescription.CsvToEnum<RoofDescription>(true)))
                .ForMember(dto => dto.SpecialtyRooms, cr => cr.Ignore())
                .ForMember(dto => dto.SupplierElectricity, cr => cr.Ignore());
            this.CreateMap<FinancialResponse, CommunityFinancialInfo>()
                .ForMember(dto => dto.IsMultipleTaxed, cr => cr.Ignore())
                .ForMember(dto => dto.ProposedTerms, cr => cr.MapFrom(x => x.ProposedTerms.CsvToEnum<ProposedTerms>(true)))
            ...
            this.CreateMap<ShowingResponse, CommunityShowingInfo>()
                .ForMember(dto => dto.Showing, cr => cr.MapFrom(x => x.Showing.GetEnumValueFromDescription<Showing>()))
            ...
            this.CreateMap<HoaResponse, CommunityHoa>()
                ...
                .ForMember(dto => dto.CommunitySaleId, cr => cr.Ignore())
                .ForMember(dto => dto.BillingFrequency, cr => cr.Ignore())
                .ForMember(dto => dto.HoaType, cr => cr.Ignore())
            ...
            this.CreateMap<CommunityResponse, CommunitySale>()
                ...
                .ForMember(dto => dto.Id, cr => cr.Ignore())
                .ForMember(dto => dto.CommunityHoas, cr => cr.Ignore())
