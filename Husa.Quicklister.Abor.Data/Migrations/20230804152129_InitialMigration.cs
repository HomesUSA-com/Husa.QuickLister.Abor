        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxExemptions = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    HoaName = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: true),
                    HoaFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    BillingFrequency = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
                    ...
                    ConstructionStage = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    Appliances = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    GarageSpaces = table.Column<int>(type: "int", maxLength: 20, nullable: true),
                    GarageDescription = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    LaundryFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    LaundryLocation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    InteriorFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    KitchenFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    MasterBedroomFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    WaterAccessDescription = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    SecurityFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    WindowFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Foundation = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    RoofDescription = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Fencing = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ConstructionMaterials = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    PatioAndPorchFeatures = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    OtherElementarySchool = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MiddleSchool = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OtherMiddleSchool = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HighSchool = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    OtherHighSchool = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SysCreatedOn = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                    SysModifiedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SysModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoriesTotal = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    SqFtTotal = table.Column<int>(type: "int", maxLength: 11, nullable: true),
                    DiningAreasTotal = table.Column<int>(type: "int", maxLength: 1, nullable: true),
                    MainLevelBedroomTotal = table.Column<int>(type: "int", maxLength: 1, nullable: true),
                    OtherLevelsBedroomTotal = table.Column<int>(type: "int", maxLength: 1, nullable: true),
                    HalfBathsTotal = table.Column<int>(type: "int", maxLength: 3, nullable: true),
                    FullBathsTotal = table.Column<int>(type: "int", maxLength: 50, nullable: true),
                    LivingAreasTotal = table.Column<int>(type: "int", maxLength: 11, nullable: true),
                    SysCreatedOn = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                    SysModifiedOn = table.Column<DateTime>(type: "datetime", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SysModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
