...
namespace Husa.Quicklister.Abor.Data.Migrations
{
    ...
    /// <inheritdoc />
    public partial class V2220_AddEmailsToViolationWarning : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViolationWarningLog", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ViolationWarningLog",
