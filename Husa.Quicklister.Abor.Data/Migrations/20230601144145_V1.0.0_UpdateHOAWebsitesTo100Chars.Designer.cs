...
namespace Husa.Quicklister.Abor.Data.Migrations
{
    ...
    [Migration("20230601144145_V1.0.0_UpdateHOAWebsitesTo100Chars")]
    partial class V100_UpdateHOAWebsitesTo100Chars
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Base.Hoa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("Id")
                        .IsUnique()
                        .HasDatabaseName("IX_Hoa");

                    b.ToTable("HOA");

                    b.HasDiscriminator<string>("HoaType").IsComplete(false);
                });

            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Base.OpenHouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Community.CommunityHoa", b =>
                {
                    b.HasBaseType("Husa.Quicklister.Abor.Domain.Entities.Base.Hoa");

                    b.Property<Guid>("CommunitySaleId")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("CommunitySaleId");
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Community.CommunityOpenHouse", b =>
                {
                    b.HasBaseType("Husa.Quicklister.Abor.Domain.Entities.Base.OpenHouse");
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Listing.SaleListingHoa", b =>
                {
                    b.HasBaseType("Husa.Quicklister.Abor.Domain.Entities.Base.Hoa");
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Community.CommunitySale", b =>
                {
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Community.CommunityFinancialInfo", "Financial", b1 =>
                        {
                            ...
                            b1.Property<bool>("IsMultipleTaxed")
                                .HasColumnType("bit");

                            b1.Property<string>("ProposedTerms")
                                .HasMaxLength(100)
                                .HasColumnType("nvarchar(100)")
                                .HasColumnName("ProposedTerms");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Listing.SchoolsInfo", "SchoolsInfo", b1 =>
                        {
                            b1.Property<Guid>("CommunitySaleId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Community.CommunityShowingInfo", "Showing", b1 =>
                        {
                            ...
                            b1.Property<string>("AgentListApptPhone")
                                .HasMaxLength(14)
                                .HasColumnType("nvarchar(14)")
                                .HasColumnName("AgentListApptPhone");

                            b1.Property<string>("AltPhoneCommunity")
                                .HasMaxLength(14)
                                .HasColumnType("nvarchar(14)")
                                .HasColumnName("AltPhoneCommunity");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Community.Property", "Property", b1 =>
                        {
                            ...
                            b1.Property<string>("MapscoGrid")
                                .HasMaxLength(5)
                                .HasColumnType("nvarchar(5)")
                                .HasColumnName("MapscoGrid");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Plan.BasePlan", "BasePlan", b1 =>
                        {
                            ...
                            b1.Property<int?>("BathsFull")
                                .HasMaxLength(14)
                                .HasColumnType("int")
                                .HasColumnName("BathsFull");

                            b1.Property<int?>("BathsHalf")
                                .HasMaxLength(10)
                                .HasColumnType("int")
                                .HasColumnName("BathsHalf");
                            ...
                            b1.Property<int?>("NumBedrooms")
                                .HasMaxLength(255)
                                .HasColumnType("int")
                                .HasColumnName("NumBedrooms");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Listing.FeaturesInfo", "FeaturesInfo", b1 =>
                        {
                            ...
                            b1.Property<bool>("HasPrivatePool")
                                .HasColumnType("bit")
                                .HasColumnName("HasPrivatePool");
                            ...
                            b1.Property<string>("HousingStyle")
                                .HasMaxLength(255)
                                .HasColumnType("nvarchar(255)")
                                .HasColumnName("HousingStyle");
                            ...
                            b1.Property<string>("WindowCoverings")
                                .HasMaxLength(100)
                                .HasColumnType("nvarchar(100)")
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Listing.FinancialInfo", "FinancialInfo", b1 =>
                        {
                            ...
                            b1.Property<bool>("HasMultipleHOA")
                                .HasColumnType("bit");

                            b1.Property<bool>("IsMultipleTaxed")
                                .HasColumnType("bit")
                                .HasColumnName("IsMultipleTaxed");

                            b1.Property<int>("NumHOA")
                                .HasMaxLength(2)
                                .HasColumnType("int")
                                .HasColumnName("NumHOA");
                    ...
                    b.OwnsOne("Husa.Quicklister.Abor.Domain.Entities.Listing.SpacesDimensionsInfo", "SpacesDimensionsInfo", b1 =>
                        {
                            ...
                            b1.Property<string>("OtherParking")
                                .HasMaxLength(40)
                                .HasColumnType("nvarchar(40)")
                                .HasColumnName("OtherParking");
                            ...
                            b1.Property<string>("SqFtSource")
                                .HasMaxLength(10)
                                .HasColumnType("nvarchar(10)")
                                .HasColumnName("SqFtSource");
                            ...
                            b1.Property<string>("TypeCategory")
                                .IsRequired()
                                .HasMaxLength(5)
                                .HasColumnType("nvarchar(5)")
            ...
            modelBuilder.Entity("Husa.Quicklister.Abor.Domain.Entities.Community.CommunityHoa", b =>
                {
                    b.HasOne("Husa.Quicklister.Abor.Domain.Entities.Community.CommunitySale", null)
                        .WithMany("CommunityHoas")
                        .HasForeignKey("CommunitySaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
