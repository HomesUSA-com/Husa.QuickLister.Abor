namespace Husa.Quicklister.Abor.Data.Configuration
{
    ...
    public class PlanConfiguration : IEntityTypeConfiguration<Plan>
    {
        ...
        {
            builder.Property(r => r.BathsFull).HasColumnName(nameof(BasePlan.BathsFull)).HasMaxLength(14);
            builder.Property(r => r.BathsHalf).HasColumnName(nameof(BasePlan.BathsHalf)).HasMaxLength(10);

            builder.Property(x => x.GarageDescription)
                .HasColumnName(nameof(IProvideSpacesDimensions.GarageDescription))
                .HasMaxLength(255)
                .IsRequired(false)
                .HasConversion<EnumListValueConverter<GarageDescription>>(new EnumCollectionValueComparer<GarageDescription>());
            ...
            builder.Property(r => r.NumBedrooms).HasColumnName(nameof(BasePlan.NumBedrooms)).HasMaxLength(255);
