namespace Husa.Quicklister.Abor.Data.Configuration
{
    ...
    public class CommunityConfiguration : IEntityTypeConfiguration<CommunitySale>
    {
        ...
        {
            builder.Property(r => r.Name).HasColumnName(nameof(ProfileInfo.Name)).IsRequired().HasMaxLength(ProfileInfo.CommunityNameMaxLength);
            ...
            builder.Property(r => r.EmailMailViolationsWarnings).HasColumnName(nameof(ProfileInfo.EmailMailViolationsWarnings)).HasMaxLength(600)
            .IsRequired(false)
