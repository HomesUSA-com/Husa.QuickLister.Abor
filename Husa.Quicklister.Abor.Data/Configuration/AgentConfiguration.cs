namespace Husa.Quicklister.Abor.Data.Configuration
{
    ...
    public class AgentConfiguration : IEntityTypeConfiguration<Agent>
    {
        ...
        private static void ConfigureValueObject(OwnedNavigationBuilder<Agent, AgentValueObject> builder)
        {
            ...
            builder.Property(f => f.LoginName).HasMaxLength(20).HasColumnName(nameof(AgentValueObject.LoginName));
            ...
            builder.Property(f => f.OtherPhone).HasMaxLength(20).HasColumnName(nameof(AgentValueObject.OtherPhone));
            builder.Property(f => f.MarketModified).HasColumnType("datetime").HasColumnName(nameof(AgentValueObject.MarketModified));
        }
    }
}
