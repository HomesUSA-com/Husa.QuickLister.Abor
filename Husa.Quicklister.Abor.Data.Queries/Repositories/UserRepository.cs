namespace Husa.Quicklister.Abor.Data.Queries.Repositories
{
    ...
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(IUserCacheRepository userCacheRepository)
        {
            this.userCacheRepository = userCacheRepository ?? throw new ArgumentNullException(nameof(userCacheRepository));
        }
        ...
        public Task<IEnumerable<Response.User>> GetUsersById(IEnumerable<Guid> userIds)
            => this.userCacheRepository.GetUsers(userIds);
    }
}
